...
#define NODE_MAIN_LOGGER_NAME "fake_vel_transform_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libfake_vel_transform.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<fake_vel_transform::FakeVelTransform>";

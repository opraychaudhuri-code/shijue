...
#define NODE_MAIN_LOGGER_NAME "ign_sim_pointcloud_tool_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libign_sim_pointcloud_tool.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ign_sim_pointcloud_tool::PointCloudConverter>";

...
#define NODE_MAIN_LOGGER_NAME "loam_interface_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libloam_interface.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<loam_interface::LoamInterfaceNode>";

...
#define NODE_MAIN_LOGGER_NAME "pb2025_sentry_behavior_client"
...
int main(int argc, char * argv[])
{
  ...
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<pb2025_sentry_behavior::SentryBehaviorClient>";

...
#define NODE_MAIN_LOGGER_NAME "pb_teleop_twist_joy_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libpb_teleop_twist_joy.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<pb_teleop_twist_joy::TeleopTwistJoyNode>";

...
#define NODE_MAIN_LOGGER_NAME "pcd2pgm_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libpcd2pgm.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<pcd2pgm::Pcd2PgmNode>";

...
#define NODE_MAIN_LOGGER_NAME "image_task_demo"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libimage_task_demo_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<rmoss_cam::ImageTaskDemoNode>";

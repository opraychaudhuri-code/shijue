...
#define NODE_MAIN_LOGGER_NAME "virtual_cam"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libvirtual_cam_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<rmoss_cam::VirtualCamNode>";

...
#ifndef RMOSS_INTERFACES__SRV__DETAIL__CONTROL_TASK__FUNCTIONS_H_
#define RMOSS_INTERFACES__SRV__DETAIL__CONTROL_TASK__FUNCTIONS_H_
 ...
 * calls
 * rmoss_interfaces__srv__ControlTask_Request__init().
...
/**
 * It calls
 * rmoss_interfaces__srv__ControlTask_Request__fini()
 ...
 * rmoss_interfaces__srv__ControlTask_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * rmoss_interfaces__srv__ControlTask_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rmoss_interfaces__srv__ControlTask_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rmoss_interfaces
...
/**
 * It calls
 * rmoss_interfaces__srv__ControlTask_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rmoss_interfaces
...
/**
 * It allocates the memory for the array and calls
 * rmoss_interfaces__srv__ControlTask_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rmoss_interfaces
...
/**
 * It calls
 * rmoss_interfaces__srv__ControlTask_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // RMOSS_INTERFACES__SRV__DETAIL__CONTROL_TASK__FUNCTIONS_H_

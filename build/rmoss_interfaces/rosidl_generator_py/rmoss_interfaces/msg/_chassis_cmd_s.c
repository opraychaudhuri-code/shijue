...
bool rmoss_interfaces__msg__chassis_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmoss_interfaces.msg._chassis_cmd.ChassisCmd", full_classname_dest, 44) == 0);
  }
  rmoss_interfaces__msg__ChassisCmd * ros_message = _ros_message;
  {  // tid
...
{
  /* NOTE(esteve): Call constructor of ChassisCmd */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmoss_interfaces.msg._chassis_cmd");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ChassisCmd");

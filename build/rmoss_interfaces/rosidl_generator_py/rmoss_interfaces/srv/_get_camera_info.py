...
class Metaclass_GetCameraInfo(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'rmoss_interfaces.srv.GetCameraInfo')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from rmoss_interfaces.srv import _get_camera_info
...
class GetCameraInfo(metaclass=Metaclass_GetCameraInfo):
    from rmoss_interfaces.srv._get_camera_info import GetCameraInfo_Request as Request
    from rmoss_interfaces.srv._get_camera_info import GetCameraInfo_Response as Response

...
#include "rmoss_interfaces/msg/detail/chassis_cmd__rosidl_typesupport_fastrtps_c.h"
...
using _ChassisCmd__ros_msg_type = rmoss_interfaces__msg__ChassisCmd;
...
static uint32_t _ChassisCmd__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmoss_interfaces__msg__ChassisCmd(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rmoss_interfaces__msg__ChassisCmd;
    is_plain =
      (
...
static size_t _ChassisCmd__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rmoss_interfaces__msg__ChassisCmd(

...
#include "rmoss_interfaces/msg/detail/gimbal__rosidl_typesupport_fastrtps_c.h"
...
using _Gimbal__ros_msg_type = rmoss_interfaces__msg__Gimbal;
...
static uint32_t _Gimbal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmoss_interfaces__msg__Gimbal(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rmoss_interfaces__msg__Gimbal;
    is_plain =
      (
...
static size_t _Gimbal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rmoss_interfaces__msg__Gimbal(

...
#include "rmoss_interfaces/srv/detail/get_camera_info__rosidl_typesupport_fastrtps_c.h"
...
using _GetCameraInfo_Request__ros_msg_type = rmoss_interfaces__srv__GetCameraInfo_Request;
...
size_t get_serialized_size_rmoss_interfaces__srv__GetCameraInfo_Request(
  const void * untyped_ros_message,
...
static uint32_t _GetCameraInfo_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmoss_interfaces__srv__GetCameraInfo_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rmoss_interfaces
size_t max_serialized_size_rmoss_interfaces__srv__GetCameraInfo_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rmoss_interfaces__srv__GetCameraInfo_Request;
    is_plain =
      (
...
static size_t _GetCameraInfo_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rmoss_interfaces__srv__GetCameraInfo_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmoss_interfaces, srv, GetCameraInfo_Request)() {
...
using _GetCameraInfo_Response__ros_msg_type = rmoss_interfaces__srv__GetCameraInfo_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rmoss_interfaces
size_t get_serialized_size_rmoss_interfaces__srv__GetCameraInfo_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetCameraInfo_Response__ros_msg_type * ros_message = static_cast<const _GetCameraInfo_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_rmoss_interfaces__srv__GetCameraInfo_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rmoss_interfaces
size_t max_serialized_size_rmoss_interfaces__srv__GetCameraInfo_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rmoss_interfaces__srv__GetCameraInfo_Response;
    is_plain =
      (
...
static size_t _GetCameraInfo_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rmoss_interfaces__srv__GetCameraInfo_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmoss_interfaces, srv, GetCameraInfo_Response)() {
...
// already included above
// #include "rmoss_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "rmoss_interfaces/srv/get_camera_info.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmoss_interfaces, srv, GetCameraInfo)() {

...
#include "rmoss_interfaces/srv/detail/get_task_status__rosidl_typesupport_fastrtps_c.h"
...
using _GetTaskStatus_Request__ros_msg_type = rmoss_interfaces__srv__GetTaskStatus_Request;
...
size_t get_serialized_size_rmoss_interfaces__srv__GetTaskStatus_Request(
  const void * untyped_ros_message,
...
static uint32_t _GetTaskStatus_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmoss_interfaces__srv__GetTaskStatus_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rmoss_interfaces
size_t max_serialized_size_rmoss_interfaces__srv__GetTaskStatus_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rmoss_interfaces__srv__GetTaskStatus_Request;
    is_plain =
      (
...
static size_t _GetTaskStatus_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rmoss_interfaces__srv__GetTaskStatus_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmoss_interfaces, srv, GetTaskStatus_Request)() {
...
using _GetTaskStatus_Response__ros_msg_type = rmoss_interfaces__srv__GetTaskStatus_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rmoss_interfaces
size_t get_serialized_size_rmoss_interfaces__srv__GetTaskStatus_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetTaskStatus_Response__ros_msg_type * ros_message = static_cast<const _GetTaskStatus_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_rmoss_interfaces__srv__GetTaskStatus_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rmoss_interfaces
size_t max_serialized_size_rmoss_interfaces__srv__GetTaskStatus_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rmoss_interfaces__srv__GetTaskStatus_Response;
    is_plain =
      (
...
static size_t _GetTaskStatus_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rmoss_interfaces__srv__GetTaskStatus_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmoss_interfaces, srv, GetTaskStatus_Response)() {
...
// already included above
// #include "rmoss_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "rmoss_interfaces/srv/get_task_status.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmoss_interfaces, srv, GetTaskStatus)() {

...
{
  new (message_memory) rmoss_interfaces::msg::RefereeCmd(_init);
}

void RefereeCmd_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rmoss_interfaces::msg::RefereeCmd *>(message_memory);
  typed_message->~RefereeCmd();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember RefereeCmd_message_member_array[2] = {
  {
    "cmd",  // name
    ...
    offsetof(rmoss_interfaces::msg::RefereeCmd, cmd),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rmoss_interfaces::msg::RefereeCmd, robot_name),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RefereeCmd_message_members = {
  ...
  2,  // number of fields
  sizeof(rmoss_interfaces::msg::RefereeCmd),
...
{
  return &::rmoss_interfaces::msg::rosidl_typesupport_introspection_cpp::RefereeCmd_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rmoss_interfaces, msg, RefereeCmd)() {
  return &::rmoss_interfaces::msg::rosidl_typesupport_introspection_cpp::RefereeCmd_message_type_support_handle;
}

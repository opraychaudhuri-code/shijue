...
#define NODE_MAIN_LOGGER_NAME "sensor_scan_generation_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libsensor_scan_generation.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<sensor_scan_generation::SensorScanGenerationNode>";
